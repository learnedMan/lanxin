        ...
        <div v-show="returntvList.length>0" class="pbox" style="display:flex;padding-top:20px;width:1530px;">
            ...
            <div class="right" style="width:1400px;">
                <div>
                    ...
                    <el-radio-group @change="pickerdatechange" v-model="queryParams.date" style="margin-left:20px;">
                        <el-radio-button :label="nowDate(0)">{{nowDate(0)|dateformat('today')}}</el-radio-button>
                        <template v-for="(item,index) in 6">
                            <el-radio-button :label="nowDate(item)">{{nowDate(item)|dateformat()}}</el-radio-button>
                        </template>
                    </el-radio-group>
